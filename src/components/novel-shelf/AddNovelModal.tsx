...
export function AddNovelModal() {
  const { currentView, navigate, addNovel, authorName } = useNovelShelfStore();
  ...
  const handleSubmit = () => {
    if (!title.trim()) {
      toast.error('Judul novel wajib diisi');
      return;
    }
    const id = addNovel({
      title: title.trim(),
      author: author.trim() || 'Penulis',
          ...
          >
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex justify-center mb-2">
                <div
                  className="w-28 h-40 rounded-xl shadow-md overflow-hidden relative group cursor-pointer"
                ...
                >
                  {coverImage ? (
                    ...
                    <div className="w-full h-full flex flex-col items-center justify-center gap-2">
                      <span className="text-white/90 font-bold text-center text-sm leading-tight px-3 drop-shadow-md">
                        {title || 'Judul Novel'}
                      </span>
                    </div>
                  )}
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Sinopsis atau deskripsi singkat..."
                  rows={3}
